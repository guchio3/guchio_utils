...
alias drc='docker run -it --privileged --device /dev/fuse --name kaggle_cpu --ipc=host -v $HOME/.ssh:/root/.ssh -v $HOME/.kaggle:/root/.kaggle -w /workspace -p 8888:8888 -e TZ=Asia/Tokyo kaggle_cpu bash'
alias drg='nvidia-docker run -it --privileged --device /dev/fuse --name kaggle_gpu --ipc=host -v $HOME/.ssh:/root/.ssh -v $HOME/.kaggle:/root/.kaggle -w /workspace -p 8888:8888 -e TZ=Asia/Tokyo kaggle_gpu bash'
